...
const defaultVideo: VideoData = {
	headline: "See How We Transform Businesses",
		...
		<section className="py-24 px-6 relative z-10">
			<div className="max-w-5xl mx-auto text-center space-y-12">
				<motion.div
					...
					viewport={{ once: true }}
				>
					<span className="text-neon-green font-mono text-sm tracking-widest uppercase mb-4 block">
						{subheadline}
					</span>
				...
				>
					...
					{!isPlaying ?
						<div
							className="absolute inset-0 bg-neutral-950 flex flex-col items-center justify-center cursor-pointer group p-8"
						...
						>
							...
							>
								...
								<span className="text-3xl font-black text-neon-green relative z-10 tracking-tighter">
									AI
								</span>
							</motion.div>
							...
							<div className="w-full max-w-xs space-y-3 mb-12">
								...
								<div className="flex justify-center">
									<span className="text-[10px] font-mono text-neutral-500 uppercase tracking-[0.2em] animate-pulse">
										Analyzing Data
									</span>
								</div>
							</div>
