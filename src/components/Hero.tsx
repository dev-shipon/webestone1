		...
		<section className="relative min-h-[90svh] flex items-center justify-center px-6 overflow-hidden z-10 pt-20">
			<div className="container max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
				...
				>
					...
					>
						Your brand does not need just another post. It needs attention,
						engagement, and conversions. At WeBestOne, we combine creativity,
						data, and artificial intelligence to turn ideas into measurable
						business growth. From design and marketing to intelligent
						automation, every solution we create is made to stand out, perform,
						and succeed.
					</motion.p>
						...
						<div className="relative group">
							...
							<MagneticButton className="relative px-8 py-4 bg-neon-green rounded-full leading-none flex items-center divide-x divide-transparent border border-neon-green/50 hover:bg-neon-green/90 transition-colors duration-300 shadow-[0_0_20px_rgba(0,255,157,0.3)]">
								<span className="flex items-center space-x-5">
									<span className="pr-4 text-black font-bold group-hover:text-black transition-colors">
										Start My Growth
									</span>
								</span>
